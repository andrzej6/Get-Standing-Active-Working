...
@section('content-smallwidth')
    ...
    <div class="gbsintro">
        ...
        70% of sedentary behavior takes place at work. Active Working’s mission is to:
        <br/><br/>


        <ul>
            <li>Promote simple, concise and effective campaigns to key stakeholders on the health risks
                caused by prolonged sitting and excessive sedentary behavior</li>
...
@section('content-restofsmall')
    ...
    <a href="http://onyourfeetday.com/canada" class="darken" target="_blank">
        <img src="img/getstanding/can/ads/oyf/oyf18d.jpg" alt="oyf"/>
    </a>
