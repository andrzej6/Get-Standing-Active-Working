...
@section('content-smallwidth')
                ...
                <div class="module_content slider_type1">
                    <div id="banner1" class="OneByOne_container">
                        ...
                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/can/slider/subpage/40percent.png" alt="microsoft">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/can/slider/subpage/90min.png" alt="microsoft">
                        </div>
    ...
    <div class="row-fluid link-line">
        ...
        <span style="color:black;">(BLACK)</span> and supplementary research studies
...
@section('content-restofsmall')
    ...
    <a href="http://onyourfeetday.com/canada" class="darken" target="_blank">
        <img src="img/getstanding/can/ads/oyf/oyf1.jpg" alt="oyf"/>
    </a>
