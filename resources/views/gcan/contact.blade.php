...
@section('header-styles')
    @parent
    <link rel="stylesheet" type="text/css" href="css/gcan/contact.css">
...
@section('content')
        ...
        {!!  Form::open(array('url' => 'gcan_reg','class' => 'register_form','onsubmit' => 'return check_if_capcha_is_filled();')) !!}
                ...
                <div class="checkbox-group">
                    <div class="checkbox-tabbed">
                            ...
                            <div style="color:black;font-size: 14px">
                                Get Canada Standing will shortly make available discounts off various sit-stand
