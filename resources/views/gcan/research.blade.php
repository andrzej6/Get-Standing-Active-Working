...
@section('content-smallwidth')
    <div class="row-fluid nonavarrows">
        ...
        <img src="img/getstanding/can/slider/subpage/areyouactive.png" alt="active">
...
@section('content-restofsmall')
    ...
    <a href="http://onyourfeetday.com/canada" class="darken" target="_blank">
        <img src="img/getstanding/can/ads/oyf/oyf18g.jpg" alt="oyf"/>
    </a>
    ...
    <img src="img/getstanding/can/ads/message/feelaftergreen.png" class="restofsmall-pic" alt="feel after"/>
