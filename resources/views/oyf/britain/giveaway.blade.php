...
@section('title')
    On Your Feet Britain - £25,000 Giveaway
@endsection
...
@section('aw-maincontent')
    ...
    <span class="oyf-newpink">
	To qualify for <strong>£50 OFF</strong> any standing desk all you need to do is register for <strong>On Your Feet 2019</strong> and we 
	will send you a <strong>£50 voucher code</strong> to spend with <a href="https://sit-stand.com" style="font-weight:bold;text-decoration:underline" class="oyf-newpink">Sit-Stand.Com</a>, to be used 
	<span style="font-weight:bold;text-decoration:underline">before 26th April 2019</span>.
	</span><br/><br/>
   ...
   <a href="https://www.instagram.com/?hl=en" style="color:#1136d3;font-weight: bold;text-decoration:underline" target="_blank">Instagram</a> or 	
	...
	using
    <span style="color:#57b8d9;font-weight: bold">#OYF19</span> or
   ...
   <strong>before April 30th 2019</strong>. The winners will be selected from the most imaginative, funny and original captions posted. 
   ...
   <span style="color:#57b8d9;font-weight: bold">On Your Feet Day</span>.
	...
	<span style="font-weight: bold;font-size: 16px" class="oyf-newblue">Best Group:</span><br/><br/>
		...
		<br/><br/>
		<div class="oyf-fwidth inblock">Runner-up</div><div class="inblock">3 x £250 each </div>
		<br/><br/><br/>
