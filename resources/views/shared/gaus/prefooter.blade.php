        ...
        <aside id="footer_bar" class="row">
            ...
            <div class="span3">
                ...
                <div class="sidepanel widget_about">
                    ...
                    <img src="img/getstanding/aus/logos/prefooter.png" width="88" height="88" class="alignleft" alt="about us"/>

                    <div id="textprefooter">

                        Get Australia Standing is a dynamic campaign to increase awareness and education of the dangers of
            ...
            <div class="span3">
                ...
                <div class="sidepanel widget_recent_entries">
                    ...
                    <div class="widget_flickr">
                        <script src="https://www.flickr.com/badge_code_v2.gne?count=9&amp;display=latest&amp;size=s&amp;layout=x&amp;source=user&amp;user=132414754@N07"></script>
                    </div>
            ...
            <div class="span3">
                ...
                <div class="sidepanel widget_twitter">
                    ...
                    <a class="twitter-timeline" href="https://twitter.com/getOZstanding" data-widget-id="609325051427573760">Tweets by @getOZstanding</a>
                    <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");
                    </script>


                    <a href="https://twitter.com/getOZstanding" class="twitter-follow-button" data-show-count="false" data-size="large">Follow @getOZstanding</a>
