        ...
        <aside id="footer_bar" class="row">
            ...
            <div class="span3">
                ...
                <div class="sidepanel widget_about">
                    ...
                    <img src="img/getstanding/usa/logos/prefooter.png" width="88" height="88" class="alignleft" alt="about us"/>

                    <div id="textprefooter">

                        Get America Standing is a dynamic campaign to increase awareness and education of the dangers of sedentary
                        working and prolonged sitting time. Regular minor movement while at work is essential for us to:
                        <ul>
            ...
            <div class="span3">
                ...
                <div class="sidepanel widget_recent_entries">
                    ...
                    <div class="widget_flickr">
                        <script src="https://www.flickr.com/badge_code_v2.gne?count=9&amp;display=latest&amp;size=s&amp;layout=x&amp;source=user&amp;user=132941138@N07"></script>
                    </div>
            ...
            <div class="span3">
                ...
                <div class="sidepanel widget_twitter">
                    ...
                    <a class="twitter-timeline"   href="https://twitter.com/getUSAstanding"
                       data-widget-id="605054394510548993">Tweets by @getUSAstanding</a>
                    ...
                    <a href="https://twitter.com/getUSAstanding" class="twitter-follow-button" data-show-count="false" data-size="large">Follow @getUSAstanding</a>
                    <script>
                        !function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+'://platform.twitter.com/widgets.js';fjs.parentNode.insertBefore(js,fjs);}}(document, 'script', 'twitter-wjs');
                    </script>
