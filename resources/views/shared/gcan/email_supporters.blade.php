<div>
    Get Canada Standing is proud to be associated with the following
    ...
    <strong> Active Working C.I.C  <br/>
        Get Canada Standing campaign </strong>

    <br/><br/>

    <div style="font-size:0.8em;text-align:justify">
        <span style="font-weight:bold;color:#EA1E30">Get Canada Standing:</span> a campaign to grow awareness
