...
-->
    ...
    <div class="aw-logo">
        <img src="{{ url('/') }}/img/aw/summit/2015/toplogo.jpg" class="aw-logo-small"/>
        <!-- <img src="/images/soldout-small.jpg" class="aw-soldout-small" /> -->
    </div>
    <!-- <div class="center-bottom bookline"><a href="/summit">Book early for AWS 2016 to avoid disappointment</a></div> -->


    <div class="center-bottom">"THE SEDENTARY OFFICE: a growing case for change towards better health and productivity”</div>
