...
Active Working Summit is proud to be associated with the following
<strong>"Official Partners"</strong>: <br/>

<a href="http://www.klgates.com/" style="color:#009999;">
    <img src="{{ url('/') }}/img/aw/summit/partners/klgates.jpg" width="150"/></a>&nbsp;&nbsp;&nbsp;

<a href="http://sit-stand.com/" style="color:#009999;">
    <img src="{{ url('/') }}/img/general/emails/supporters/sit-stand.jpg" width="150"/></a>&nbsp;&nbsp;&nbsp;

<a href="http://www.aeris.de/en/" style="color:#009999;">
    <img src="{{ url('/') }}/img/aw/summit/partners/aeris.png" width="150"/></a>&nbsp;&nbsp;&nbsp;
...
<strong> Active Working C.I.C </strong> <br/>
    ...
    <div style="font-size:0.8em;text-align:justify">
        ...
        <a href="http://activeworking.com/expert_statement">global expert recommendations </a>
