...
@section('header-styles')
    @parent
    <link rel="stylesheet" type="text/css" href="css/gusa/index.css">
...
@section('title')
    Get America Standing. Active and Productive working. Sit-stand solutions.
@endsection
    ...
    <div id="homemaincont">
                ...
                <div class="module_content slider_type1">
                    <div id="banner1" class="OneByOne_container">
                        ...
                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/usa/slider/big/oyf19-us.jpg" alt="" class="go-to go-to-oyf">
                        </div>
                        ...
                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/usa/slider/big/slider3.jpg" alt="">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/usa/slider/big/slider4.jpg" alt="">
                        </div>
                        ...
                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/usa/slider/big/slider7.jpg" alt="">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/usa/slider/big/slider8.jpg" alt="">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/usa/slider/big/slider9.jpg" alt="">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/usa/slider/big/slider10.jpg" alt="">
                        </div>
        ...
        <div class="row-fluid">
            ...
            <div class="halfleft1">
                ...
                <div id="leftsitcalc">
                    <h4 class="custom-h4">Americans sit almost 10 hours each day (on average)</h4>
            ...
            <div class="halfright1">
                ...
                <div id="sitcalc">
                    ...
                    <div class="calc-container">
                        ...
                        <div class="calc-powered">Powered by &nbsp;<img src="img/getstanding/usa/logos/calc-powered.png" /></div>
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="aw_summit" target="_blank">
                                    ...
                                    <div class="item" style="height: 266px;">
                                        ...
                                        <div class="img_block">
                                            <img src="img/getstanding/usa/carousel/slider1.jpg" alt="summit 2017"/><div class="carousel_wrapper"></div><span class="post_type post_type_image"></span></div>
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="http://onyourfeetday.com/america" target="_blank">
                                    ...
                                    <div class="item" style="height: 266px;">
                                        ...
                                        <div class="img_block">
                                            <img src="img/getstanding/usa/carousel/slider4.jpg" alt="media and sit-stand"/><div class="carousel_wrapper"></div><span class="post_type post_type_image"></span></div>

                                        <div class="carousel_title">
                                            <h4 class="featured_ico_slider">On Your Feet America</h4>
                                        </div>
...
@section('footer-scripts')
    @parent
    <script type="text/javascript" src="js/gusa/calculator.js"></script>
