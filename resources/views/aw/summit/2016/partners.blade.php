@extends('layouts.aw.summit-2016')
...
@section('title')
    Active Working Summit 2016. Partners
@endsection
...
@section('aw-maincontent')
    ...
    <div class="aw-partners-row-m">
        ...
        <div class="aw-partners-logo-m">
            <a href="https://www.gymflex.co.uk/" target="_blank">
                <img src="{{ url('/') }}/img/aw/summit/partners/gymflex.jpg"/>
            </a>
        </div>
    ...
    <div class="aw-partners-row-s">
        ...
        <div class="aw-partners-logo-s">
            <a href="http://www.imovr.com/" target="_blank">
                <img src="{{ url('/') }}/img/aw/summit/partners/imovr.jpg"/>
            </a>
        </div>

        <div class="aw-partners-text-s">
            iMovR is the leading innovator in office fitness, with more models of adjustable-height desks and tables,
            treadmill desks and ergonomic accessories than any other company.
        </div>

        <div class="aw-partners-pics-s">
            <a class="fancybox" rel="group16" href="{{ url('/') }}/img/aw/summit/partners/fancybox/imovr2.jpg">
                <img src="{{ url('/') }}/img/aw/summit/partners/fancybox/small/imovr2.jpg"/>
            </a>
    ...
    <div class="aw-partners-row-s">
        ...
        <div class="aw-partners-logo-s">
            <a href="http://www.cuckooworkout.com/en/landingpage" target="_blank">
                <img src="{{ url('/') }}/img/aw/summit/partners/cuckoo.jpg"/>
            </a>
        </div>

        <div class="aw-partners-text-s">
            Cuckoo Workout helps to significantly reduce prolonged workplace sitting by motivating office
            workers to take regular low-intensity activity breaks in a gamified format.
            Cuckoo Workout delivers improved employee wellness by promoting physical
            and mental exercise in short intervals. It is simple, fun and engaging and
            has a proven track record.
        </div>

        <div class="aw-partners-pics-s">
            <a class="fancybox" rel="group20" href="{{ url('/') }}/img/aw/summit/partners/fancybox/cukoo.png">
                <img src="{{ url('/') }}/img/aw/summit/partners/fancybox/small/cukoo.jpg"/>
            </a>
