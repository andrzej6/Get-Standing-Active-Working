            ...
            <div class="summit-section">
                ...
                <ul>
                    <li><strong>A New Horizon - Impact of the Expert Statement</strong>
                        <br/>
                        <a href="pdf/slides/2.Gavin_Bradley.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                        <!-- <a href="pdf/slides/.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp; -->
                    ...
                    <li><strong>Sedentary Behaviour Public Health Research:  What We Now Know. What We Don’t Know Yet.</strong>
                        <br/>
                        <a href="pdf/slides/3.Jason_Gill.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>How Much Sitting time is Acceptable?  And How Much is Too Much?</strong>
                        <br/>
                        <a href="pdf/slides/4.Stacy_Clemes.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
            ...
            <div class="summit-section">
                ...
                <ul>
                    <li><strong>Workplace Evidence:  What We Now Know. What We Don’t Know Yet.</strong><br/>
                        <a href="pdf/slides/5.Veerle_Hermans1.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Behaviour Change Techniques in the Workplace</strong><br/>
                        <a href="pdf/slides/6.Raluca_Matei.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Health at Work:  Growing Impact of Musculoskeletal Disorders on Productivity.</strong>
                        <br/>
                        <a href="pdf/slides/7.Stephen_Bevan.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>UK Workplace Research and Impacts on Reduction in Sedentary Behaviour.</strong>
                        <br/>
                        <a href="pdf/slides/8.Fehmidah_Munir.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Workplace Team Sport – Systematic review of individual, Group and Organisational Benefits</strong>
                        <br/>
                        <a href="pdf/slides/9.Hilary_McDermott.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
            ...
            <div class="summit-section">
                ...
                <ul>
                    ...
                    <li><strong>Ergonomics of Sit-Stand Solutions.</strong>
                        <br/>
                        <a href="pdf/slides/10.Veerle_Hermans2.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                        <span class="aw-redtext"><i><strong>Dr Veerle Hermans</strong>, Head of Ergonomics (IDEWE), Prof. Ergonomics (Free University of Brussels)</span></i>
                    </li>
                    ...
                    <li><strong>Tools to Identify, Diagnose and Remediate Health Risks of Sedentary Behaviour in the Office</strong>
                        <br/>
                        <a href="pdf/slides/11.Little_Nudge.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Creating an Open Culture to Promote Employee Wellbeing Awareness and Action</strong>
                        <br/>
                        <a href="pdf/slides/12.Amy_McKeown-HealthEY.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Education, Education, Education.</strong>
                        <br/>
                        <a href="pdf/slides/14. Sue_Jutley-Active-Working.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Breaking Down the Barriers to Equipment and Education.</strong>
                        <br/>
                        <a href="pdf/slides/13.Sit-Stand.Com.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Corporate Gyms: Strategies to Increase Employee Usage and Engagement.</strong>
                        <br/>
                        <a href="pdf/slides/15.James_Shillaker-GymFlex.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
            ...
            <div class="summit-section">
                ...
                <ul>
                    <li><strong>Cost / Benefit Analysis for Active Working and Bringing about Behaviour Change.</strong>
                        <br/>
                        <a href="pdf/slides/16.William_Bird-Intelligent-Health.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Breaking the Mould. The Challenge for Workplace Design.</strong>
                        <br/>
                        <a href="pdf/slides/17.Sam_Sahni-Morgan-Lovell.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                    ...
                    <li><strong>Our Journey to Active Working: Company Case Studies.</strong>
                        <br/>
                        <a href="pdf/slides/18.Case_Study-Austin-Fraser.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
                        <span class="aw-redtext"><i><strong>Laura Johnstone</strong>, HR Director, Austin Fraser</span></i>
                        <br/>
                        <a href="pdf/slides/19.Case_Study-Macmillan.pdf" target="_blank"><img src="/images/icon/pdficon.png" width="20"></a>&nbsp;
