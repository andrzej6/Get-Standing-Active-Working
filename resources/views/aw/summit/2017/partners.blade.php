...
@section('aw-maincontent')
    ...
    <div class="aw-partners-row-s">
        ...
        <div class="aw-partners-pics-s">
            <a class="fancybox" rel="group22" href="{{ url('/') }}/img/aw/summit/partners/fancybox/fellowes1.jpg">
    ...
    <div class="aw-partners-row-s">
        ...
        <div class="aw-partners-pics-s">
            <a class="fancybox" rel="group32" href="{{ url('/') }}/img/aw/summit/partners/fancybox/ergo-2.jpg">
    ...
    <div class="aw-partners-row-s">
        ...
        <div class="aw-partners-pics-s">
            <a class="fancybox" rel="group33" href="{{ url('/') }}/img/aw/summit/partners/fancybox/fitroom2.jpg">
                <img src="{{ url('/') }}/img/aw/summit/partners/fancybox/small/fitroom1.jpg"/>
            </a>
        </div>
        <div class="clear"></div>
    </div>
    ...
    <div class="aw-partners-row-s">
        ...
        <div class="aw-partners-pics-s">
            <a class="fancybox" rel="group34" href="{{ url('/') }}/img/aw/summit/partners/fancybox/freedesk2.jpg">
