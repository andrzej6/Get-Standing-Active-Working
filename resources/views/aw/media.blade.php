...
@section('header-styles')
    @parent
    <link rel="stylesheet" type="text/css" href="css/gcan/media.css">
@endsection

@section('description')
    What the Canadian media, press and radio are saying about sitting and sit-stand.
@endsection
...
<div class="contentarea">
    <div class="row-fluid">
        ...
        <h1>What do the Canadian media say about sitting?</h1>
        <br/>
