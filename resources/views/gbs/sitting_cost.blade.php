...
@section('content-smallwidth')
            ...
            <div class="module_content slider_type1">
                ...
                <div id="banner1" class="OneByOne_container">
                    ...
                    <div class="oneByOne_item ls_bg1">
                        <img src="img/aw/slider/subpage/microsoft.png" alt="microsoft">
                    </div>
    ...
    <div class="row-fluid">
        ...
        Sitting for prolonged periods (longer than 30 minutes at a time) and excessively (more than 4
        hours per day in the office) has a contributory effect to a variety of human factor costs which
        directly hits the bottom line of English business today: <br/><br/>
        ...
        <div class="link-line">
            ...
            <a href="http://activeworking.com/contact-us.php">Contact Us</a> as we be delighted to help. The vast majority of
...
@section('content-restofsmall')
    ...
    <img src="img/getstanding/gb/ads/message/feelafterblue.png" class="restofsmall-pic" alt="feel after"/>
