...
@section('header-styles')
    <link rel="stylesheet" type="text/css" href="css/gbs/index.css">
@endsection



@section('description')
    Get Britain Standing is a campaign to educate on Active Working. Regular minor movement whilst at work is
...
@section('keywords')
    get-britain-standing, active-working, productive-working, office-productivity, sit-stand, sit-stand-desk,
...
@section('title')
    Get Britain Standing. Active and Productive working. Sit-stand solutions.
@endsection
    ...
    <div id="homemaincont">
            ...
            <div class="span12 module_cont module_layer_slider">
                ...
                <div class="module_content slider_type1">
                    <div id="banner1" class="OneByOne_container">
                        ...
                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/gb/slider/big/slider2.jpg" alt="ukactive" class="go-to-onyourfeet">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/gb/slider/big/slider3.jpg" alt="ukactive" class="go-to-videos">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/gb/slider/big/slider4.png" alt="weight loss" class="go-to-statement">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/gb/slider/big/slider5.jpg" alt="ukactive" class="go-to-ukactive">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/gb/slider/big/slider6.jpg" alt="weight loss" class="">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/gb/slider/big/slider7.jpg" alt="ukactive" class="go-to-onyourfeet">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/gb/slider/big/slider8.jpg" alt="90 minutes of sitting" class="">
                        </div>

                        <div class="oneByOne_item ls_bg2">
                            <img src="img/getstanding/gb/slider/big/slider9.jpg" alt="80 percent want to continue sit-stand" class="">
                        </div>

                        <div class="oneByOne_item ls_bg4">
                            <img src="img/getstanding/gb/slider/big/slider10.jpg" alt="burn 50 calories more when standing" class="">
                        </div>

                        <div class="oneByOne_item ls_bg5">
                            <img src="img/getstanding/gb/slider/big/slider11.jpg" alt="sitting for more than 4 hours at work" class="">
                        </div>

                        <div class="oneByOne_item ls_bg6">
                            <img src="img/getstanding/gb/slider/big/slider12.jpg" alt="scandinavia has seen the light" class="">
                        </div>

                        <div class="oneByOne_item ls_bg7">
                            <img src="img/getstanding/gb/slider/big/slider13.jpg" alt="britain remains in the dark" class="">
                        </div>

                        <div class="oneByOne_item ls_bg8">
                            <img src="img/getstanding/gb/slider/big/slider14.jpg" alt="are you fit and active" class="">
                        </div>

                        <div class="oneByOne_item ls_bg9">
                            <img src="img/getstanding/gb/slider/big/slider15.jpg" alt="prolonged sitting">
                        </div>
        ...
        <div class="row-fluid">
            ...
            <div class="halfleft1">
                ...
                <div id="leftsitcalc">
                    <h4 class="custom-h4">British people sit for 8.9 hours each day (on average).</h4>
            ...
            <div class="halfright1">
                ...
                <div id="sitcalc">
                    ...
                    <div class="calc-container">
                        ...
                        <div class="calc-powered">Powered by &nbsp;<img src="img/getstanding/gb/logos/calc-powered.png" /></div>
        ...
        <div id="gbs-slideshow">
            ...
            <div>
                <a href="http://bhwa.org.uk/" target="_blank">
                    <img src="img/getstanding/gb/slider/thin/slider1.jpg">
                </a>
            </div>
            ...
            <div>
                <a href="https://www.gymflex.co.uk/" target="_blank">
                    <img src="img/getstanding/gb/slider/thin/slider2.jpg">
                </a>
            </div>

            <div>
                <a href="http://www.linak.com/" target="_blank">
                    <img src="img/getstanding/gb/slider/thin/slider3.jpg">
                </a>
            </div>
            ...
            <div>
                <a href="https://sit-stand.com/freetrial" target="_blank">
                    <img src="img/getstanding/gb/slider/thin/slider4.jpg">
                </a>
            </div>

            <div>
                <a href="http://sit-stand.com/comfort-mats/25-comfort-mat.html" target="_blank">
                    <img src="img/getstanding/gb/slider/thin/slider5.jpg">
                </a>
            </div>

            <div>
                <a href="http://sit-stand.com/desk-risers/50-workfit-t.html" target="_blank">
                    <img src="img/getstanding/gb/slider/thin/slider6.jpg">
                </a>
            </div>
                    ...
                    <div class="carouselslider featured_posts items4" data-count="4">
                        ...
                        <ul class="item_list">
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="http://activeworking.com/summit/register.php" target="_blank">

                                    <div class="item" style="height: 266px;">

                                        <div class="img_block">
                                            <img src="img/getstanding/gb/carousel/slider1.jpg" alt="summit 2017"/><div class="carousel_wrapper"></div><span class="post_type post_type_image"></span></div>
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="top10risks">
                                    ...
                                    <div class="item" style="height: 266px;">
                                        ...
                                        <div class="img_block">
                                            <img src="img/getstanding/gb/carousel/slider2.jpg" alt="top 10 risks"/><div class="carousel_wrapper"></div><span class="post_type post_type_image"></span></div>
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="introduction">
                                    ...
                                    <div class="item" style="height: 266px;">
                                        ...
                                        <div class="img_block">
                                            <img src="img/getstanding/gb/carousel/slider3.jpg" alt="active working"/><div class="carousel_wrapper"></div><span class="post_type post_type_video"></span></div>
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="onyourfeet">
                                    ...
                                    <div class="item" style="height: 266px;">
                                        ...
                                        <div class="img_block">
                                            <img src="img/getstanding/gb/carousel/slider4.jpg" alt="on your feet britain"/><div class="carousel_wrapper"></div><span class="post_type post_type_image"></span></div>

                                        <div class="carousel_title">
                                            <h4 class="featured_ico_img">On Your Feet Britain</h4>
                                        </div>

                                        <div class="carousel_desc">
                                            <div class="exc"> <strong>Friday 28th April 2017</strong><br/>Wiggle it, Waggle it. Just don't sit on it.</div>
                                        </div>
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="media">
                                    ...
                                    <div class="item" style="height: 266px;">
                                        ...
                                        <div class="img_block">
                                            <img src="img/getstanding/gb/carousel/slider5.jpg" alt="media and sit-stand"/><div class="carousel_wrapper"></div><span class="post_type post_type_image"></span></div>
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="research">
                                    ...
                                    <div class="item" style="height: 266px;">
                                        ...
                                        <div class="img_block">
                                            <img src="img/getstanding/gb/carousel/slider6.jpg" alt="research sit-stand"/><div class="carousel_wrapper"></div><span class="post_type post_type_video"></span></div>
                            ...
                            <li style="height: 266px; width:266px;">
                                <a href="http://activeworking.com/summit/2015" target="_blank">

                                    <div class="item" style="height: 266px;">

                                        <div class="img_block">
                                            <img src="img/getstanding/gb/carousel/slider7.jpg" alt="summit 2015"/><div class="carousel_wrapper"></div><span class="post_type post_type_image"></span></div>

                                        <div class="carousel_title">
                                            <h4 class="featured_ico_slider">Summit 2015</h4>
                                        </div>
...
@section('footer-scripts')
    <script type="text/javascript" src="js/gbs/calculator.js"></script>
