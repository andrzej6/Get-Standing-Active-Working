...
@section('header-styles')
    @parent
    <link rel="stylesheet" type="text/css" href="css/gaus/media.css">
@endsection

@section('description')
    What the Australian media, press and radio are saying about sitting and sit-stand.
@endsection
...
@section('title')
    What the Australian media are saying about Sitting and Sit-Stand
@endsection
...
<div class="contentarea">
    <div class="row-fluid">
        ...
        <h1>What do the Australian media say about sitting?</h1>
        <br/>
