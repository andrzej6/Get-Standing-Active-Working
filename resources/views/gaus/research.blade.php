...
@section('content-smallwidth')
    <div class="row-fluid nonavarrows">
        ...
        <img src="img/getstanding/aus/slider/subpage/areyouactive.png" alt="active">
    ...
    <div class="row-fluid">
        ...
        <span style="color:#009800;">(GREEN)</span>.
...
@section('content-restofsmall')
    ...
    <img src="img/getstanding/aus/ads/message/feelaftergreen.png" class="restofsmall-pic" alt="feel after"/>
