...
@section('content-smallwidth')
                ...
                <div class="module_content slider_type1">
                    <div id="banner1" class="OneByOne_container">
                        ...
                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/aus/slider/subpage/40percent.png" alt="microsoft">
                        </div>

                        <div class="oneByOne_item ls_bg1">
                            <img src="img/getstanding/aus/slider/subpage/90min.png" alt="microsoft">
                        </div>
    ...
    <div class="row-fluid link-line">
        ...
        <span style="color:#ebb034;">(YELLOW)</span> and supplementary research studies
        <span style="color:#009800;">(GREEN)</span>.<br/><br/>
...
@section('content-restofsmall')
    <img src="img/getstanding/aus/ads/message/whenyousit.png" class="restofsmall-pic" alt="advert"/>
