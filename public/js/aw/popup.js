$( document ).ready(function() {
    ...
    var windowwidth = 300;
    var margintop = 0;
    var titletext = '<img src="'+url+'/img/aw/logos/minilogo.jpg" /><span class="gbs-popup-title"> &nbsp;Keep connected.</span>';

    if ($(window).width()>550)
    {
        windowwidth = 550;
        margintop = '-113px';
        titletext = '<img src="'+url+'/img/aw/logos/minilogo.jpg" /><span class="gbs-popup-title"> &nbsp;Keep connected to our campaign. JOIN US</span>';
    }
