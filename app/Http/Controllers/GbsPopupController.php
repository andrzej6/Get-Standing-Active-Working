...
class GbsPopupController extends Controller
{
...
public function store (Request $request){
  ...
  if ($validator->fails()) {
    ...
    {
      $gbspopup = new Gbs_popup;
      $gbspopup->email=$email;
      $gbspopup->cust_key=$token;
  ...
  public function confirm (Request $request){
    ...
    return view('gbs.confirm',compact('mainMenuOutput','trail1','trail2'));
  }
